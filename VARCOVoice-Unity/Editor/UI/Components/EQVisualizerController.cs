...
namespace VARCOVoice.Editor
{
    ...
    public partial class EQVisualizerController
    {
        ...
        /// <summary>
        /// Update the ParametricEQ reference (called after Play mode exit)
        /// </summary>
        public void SetEQ(ParametricEQ16 eq)
        {
            _targetEQ = eq;
            _lastKnownEQ = eq;
            _layoutRestoreDone = false;
            ClearAllNodes();
            
            if (eq != null && _spectrumCanvas != null)
            {
