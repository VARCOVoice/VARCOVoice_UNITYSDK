...
namespace VARCOVoice.Editor
{
    public partial class EffectDetailController
    {
        ...
        private static readonly string[] LowPassPresets =
        {
            "Warm Roll-Off",
            "Muffle",
            "Underwater",
        ...
        private IReadOnlyList<string> GetPresetOptions(IDSPEffect effect)
        {
            ...
            if (effect is LowPassEffect) return LowPassPresets;
            ...
            if (effect is PhaseVocoderPitchShift) return PhaseVocoderPresets;
            if (effect is WSOLAPitchShift) return PSOLAPresets;
