...
namespace VARCOVoice
{
    ...
    [AddComponentMenu("VARCO/Dialogue Player")]
    public class VarcoDialoguePlayer : MonoBehaviour
    {
        ...
        private void CacheBlendShapeIndices(SkinnedMeshRenderer target)
        {
            ...
            // Common viseme blend shape names (auto-detect)
            ...
            string[] visemeLabels = { "Silence", "AA", "EE", "IH", "OH", "OO", "CH", "FF", "TH", "PP", "KK", "NN", "RR", "DD", "SS" };
