...
namespace VARCOVoice.LipSync
{
    ...
    public class LipSyncPlayer : MonoBehaviour
    {
        ...
        /// <summary>
        /// Play audio with pre-set lip sync data
        /// Call SetLipSyncData() before using this method
        /// </summary>
        public void PlayWithLipSync(AudioClip clip)
        {
            if (clip == null) return;
            
            // Play audio (expects lip sync data to be pre-set via SetLipSyncData)
        ...
        private void UpdateLipSync()
        {
            ...
            if (_lipSyncData != null && audioSource != null)
            {
                // Pre-analyzed data (including Enhanced data from Editor)
