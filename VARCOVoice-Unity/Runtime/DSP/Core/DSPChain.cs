...
namespace VARCOVoice.DSP
{
    ...
    public class DSPChain : MonoBehaviour
    {
        ...
        public void ApplyRobotVoice()
        {
            ...
            var pitch = new PhaseVocoderPitchShift { Semitones = -4 };
            effects.Add(pitch);
        ...
        public void ApplyRadioVoice()
        {
            ...
            var lowpass = new LowPassEffect { CutoffFrequency = 3500f };
            effects.Add(lowpass);
        ...
        {
            var effects = new List<IDSPEffect>();
            var lowpass = new LowPassEffect { CutoffFrequency = 700f };
            effects.Add(lowpass);
            ...
            var pitch = new PhaseVocoderPitchShift { Semitones = -2 };
            effects.Add(pitch);
        ...
        {
            var effects = new List<IDSPEffect>();
            var pitch = new PhaseVocoderPitchShift { Semitones = -12 };
            effects.Add(pitch);
